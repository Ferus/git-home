...
# Copyright (C) 2011 EliÃ¡n Hanisch <lambdae2@gmail.com>
...
# 2011-05-31, EliÃ¡n Hanisch <lambdae2@gmail.com>:
...
woq_settings_default = {
    'command'   : ('/whois $nick', 'the command sent to do the whois ($nick is repladed by nick)'),
