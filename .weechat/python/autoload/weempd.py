...
def init_buffer():
	global mpd_buffer
	if not mpd_buffer:
		mpd_buffer = weechat.buffer_new("weempd", "buffer_input", "", "buffer_close", "")
	if mpd_buffer:
		weechat.buffer_set(mpd_buffer, "title", "MPD Control Interface for Weechat")
		weechat.buffer_set(mpd_buffer, "display", "1")
